              ...
              <div className="lg:col-span-3" data-aos="fade-left">
                <div className="text-center sm:text-start">
                  ...
                  <p className="text-base/relaxed text-gray-500">
                    Temukan lagu-lagu dari buku lagu Bala Keselamatan dengan
                    mudah, dan nikmati fitur transpose akor untuk memainkan lagu
                    sesuai dengan nada favorit Anda.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="container">
          ...
          <div className="grid lg:grid-cols-3 grid-cols-1 gap-6 mt-16">
            ...
            >
              ...
              <p className="mt-3">
                Akses koleksi lagu-lagu rohani dari buku lagu Bala Keselamatan.
              </p>
            ...
            >
              ...
              <p className="mt-3">
                Ubah nada lagu agar sesuai dengan rentang vokal atau instrumen
                Anda.
              </p>
            ...
            >
              ...
              <p className="mt-3">
                Temukan lagu dengan mudah menggunakan fitur pencarian kami.
              </p>
