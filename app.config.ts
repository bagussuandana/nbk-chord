...
// *** song choruses *** //
import song_chorus_1_50 from "./songs/choruses/chorus-1-50";
// *** worships *** //
...
const appConfig: any = {
    ...
    title: "NBK Chord",
    description:
        "Apliaksi chord untuk Nyanyian Bala Keselamatan dan pujian demi kemuliaan Tuhan Yesus Kristus",
    ...
    song_choruses: [...song_chorus_1_50],
